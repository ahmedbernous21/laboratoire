                    ...
                    <div class="modal-body">
                        ...
                        <div class="input-group mb-4">
                            ...
                            <div class="form-check">
                                <input class="form-check-input ms-4" type="radio" name="domicile" id="domicileYes"
                                    value="yes">
                                <label class="form-check-label" for="domicileYes"> Oui</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input ms-4" type="radio" name="domicile" id="domicileNo" value="no"
                                    checked>
